                    ...
                    <div class="col-lg-12">
                        <div class="breadcrumb-text">
                            ...
                            <div class="breadcrumb-controls">
                                <a href="scheduleClientSide.php?filter=pilates#timetable"><i class="fa fa-home"></i> Home</a>
                                <span>Pilates</span>
                            </div>
                        </div>
                    </div>
        ...
        <section class="hero-section set-bg spad" style="background-color: black;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hero-text">
                            <h2>Pilates Registration</h2>
                            <p>Get fit, feel strong, and unleash your potential with our Pilates program.</p>
                            <a href="scheduleClientSide.php?filter=pilates#timetable" class="primary-btn">Register Now</a>
                        </div>
                    </div>
                </div>
            </div>
