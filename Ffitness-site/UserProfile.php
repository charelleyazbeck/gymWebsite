...
<html lang="zxx">
    ...
    <style>
        ...
        .profile-bg {
            background-image: url("css/soura2.jpg");
            height: 100%;
        ...
        .profile-inf {
            ...
            box-shadow: 0px 8px 10px rgba(0, 0, 0, 0.2); /* Light shadow around the container */
            padding: 20px;
        ...
        .profile-links a {
            ...
            margin-left: 20px; /* Adds space between the two links */
        }
    ...
    <body class="cart-body">
        ...
        <div class="profile-bg">
            ...
            <div class="container1">
                <section class="profile-section bg-gray">
                    <div class="profile-container">
                        <div class="container">
                            <div class="section-title text-center">
                                <h2 class="store-word">PROFILE</h2>
                            </div>
                            <div class="profile-inf">
                                <?php
                                $query = "SELECT * FROM clients WHERE c_ID='$user'";
                                $res = $con->query($query);
                                // we fetch the user according to his id and show his info 
                                if ($res) {
                                    if ($res->num_rows > 0) {
                                        $row = $res->fetch_assoc();
                                        echo "
                                <p><strong>ID:</strong> $row[c_ID]</p>
                                <p><strong>Full Name:</strong> $row[c_FirstName] $row[c_LastName]</p>
                                <p><strong>Address:</strong> $row[c_Address]</p>
                                <p><strong>Phone Number:</strong> $row[c_PhoneNumber]</p>
                                <p><strong>Email:</strong> $row[c_Email]</p>
                                <p><strong>Gender:</strong> $row[c_Gender]</p>";
                                    }
                                }
                                ?>
...
<section class="chooseus-section spad" style="background-color:black">  
        ...
        function adjustMobileMenu() {
            // script inorder to make it more responsive
