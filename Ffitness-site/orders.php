                ...
                <section class="cart-section bg-gray">
                    <div class="cart-container">
                        <div class="container">
                            ...
                            <div class="cart-container" >
                                <div class="cartlistproducts">
                                    <table class="itemstable">
                                        <tr><td>Order number</td><td>Order Date</td><td>Order Price</td><td>Order Status</td><td>Order Items</td></tr>
                                        <?php
                                        $query = "SELECT * FROM orders WHERE c_ID='$user'";
                                        $res = $con->query($query);
                                        if ($res) {
                                            if ($res->num_rows == 0) {
                            ...
                            <td>$ordernumber</td>
                            <td>$row[oDateTime]</td>
                            <td class='unit-price'>$row[oAmmount]$</td>
                            <td>$row[oStatus]</td>
                            <td class='total-price'><a href='checkorderitems.php?o_ID=$row[o_ID]'><button class='remove-btn'>Check Items</button></a></td>   
                            </tr>";
                                                    $ordernumber += 1;
                                                }
                                            }
