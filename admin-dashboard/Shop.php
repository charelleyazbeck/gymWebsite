...
<div class="dashboard-buttons">
    <table>
        <tr>
        <td><a href="ShopAddItemsForm.php"><button>Add Items</button></a></td>
        <td><a href="ShopViewItems.php"><button>View Items</button></a></td>
        <td><a href="Modification.php"><button>Modifications</button></a></td>
        </tr>
    </table>
</div>
