                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-text">
                            ...
                            <p>CrossFit is a high-intensity fitness program that combines various exercises such as weightlifting, gymnastics, and cardio to improve overall fitness and athleticism.</p>
                            <p>Our program is designed to be scalable to any fitness level, so whether you're a beginner or an experienced athlete, you'll be challenged and motivated to reach your goals.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="hero-section set-bg spad" style="background-color:black";>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hero-text">
                            <h2>CrossFit Registration</h2>
                            <p>Get fit, feel strong, and unleash your potential with our CrossFit program.</p>
                            <a href="scheduleClientSide.php?filter=crossfit#timetable" class="primary-btn">Register Now</a>
                        </div>
                    </div>
                </div>
            </div>
