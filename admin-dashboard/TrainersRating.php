...
<script src="js/main.js"></script>
   ...
   <table class="viewtable"><thead>
    ...
    $query = "SELECT * FROM ratingtrainers";
    ...
    if($result){
        if($result->num_rows>0){
            ...
            while($row = $result->fetch_assoc()){
                ...
                echo "<td>$row[c_ID]</td>";
                echo "<td>$row[t_ID]</td>";
                echo "<td>$row[tRating]</td>";
                echo "<td>$row[tRatingDateTime]</td>";
                echo "</tr>";
            }
            
        }else{
            echo "<tr><td colspan='4'>No Rated Trainers</td></tr>";
        }
    }
    ?>
    </tbody></table>
