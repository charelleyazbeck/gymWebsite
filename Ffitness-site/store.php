...
<html lang="zxx">
    <head>
        ...
        <style>
            ...
            .store-item {
                display: flex;
                flex-direction: column;
                justify-content: space-between; /* Ensures that items are spaced evenly */
                height: 100%; /* Make sure it stretches to fill the available height */
            }
    ...
    <body class="store-body">
        ...
        <div class="container1">
            <section class="store-section bg-gray">
                <div class="store-container">
                    <div class="container">
                        <div class="section-title text-center">
                            <h2 class="store-word">STORE</h2>
                        </div>
                        ...
                        <div class="listproducts" id="storeItems">
                            <!--the filter is done using js in  the script down in the end of body-->
                            <?php
                            ...
                            if ($result) {
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        // Fetch the rating for each item hsb
                                        $rating = 0;
        ...
        <script>
                                    document.addEventListener('DOMContentLoaded', function () {
                                        ...
                                        function fetchItems() {
                                            ...
                                            // Use AJAX to fetch filtered and sorted data
                                            const xhr = new XMLHttpRequest();
                                            xhr.open('GET', `fetchItems.php?category=${selectedCategory}&price=${selectedPrice}`, true);
                                            xhr.onload = function () {
                                                if (xhr.status >= 200 && xhr.status < 300) {
                                                    storeItems.innerHTML = xhr.responseText;
                                        ...
                                        priceFilter.addEventListener('change', fetchItems);
                                        ...
                                        function initializeStarRatings() {
                                            ...
                                            stars.forEach(function (starContainer) {
                                                ...
                                                const starElements = starContainer.getElementsByClassName('star');
                                                for (let i = 0; i < rating; i++) {
                                                    starElements[i].classList.add('five'); // Use the 'five' class to show the filled stars
                                                }
                                            });
                                        }
