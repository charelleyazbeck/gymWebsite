...
<div class="dashboard-buttons">
    <table>
        <tr>
        <td><a href="assignordersform.php"><button>Assign</button></a></td>
        <td><a href="waitingordersform.php"><button>Waiting Delivery</button></a></td>
        <td><a href="completedordersform.php"><button>Completed</button></a></td>
        </tr>
    </table>
</div>
