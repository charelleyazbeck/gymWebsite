            ...
            <form action="login.php" method="post" class="form login">
                ...
                <div class="form__field">
                    <label for="login__username"><svg class="icon">
                        ...
                        </svg><span class="hidden">Trainer Username</span></label>
                ...
                <div class="form__field">
                    <label for="login__password"><svg class="icon">
                        ...
                        </svg><span class="hidden">Trainer Password</span></label>
                    <input id="login__password" type="password" name="password" class="form__input"
                        placeholder="trainer Password" required>
                </div>
                ...
                <div class="form__field">
                    <?php
                    if(isset($_SESSION['trainerloginerror'])){
                        if($_SESSION['trainerloginerror'] !=''){
                            echo "<p class='error'>".$_SESSION['trainerloginerror']."</p>";
                            $_SESSION['trainerloginerror'] = '';
                        }
                    }
                    ?>
                </div>
