...
<div class="dashboard-buttons">
    <table>
        <tr>
        <td><a href="PbcSchedule.php"><button>Public Schedule Edited</button></a></td>
        <td><a href="PrvSchedule.php"><button>Private Schedule Edited</button></a></td>
        </tr>
    </table>
</div>
