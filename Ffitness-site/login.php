        ...
        <div class="grid">
            <form action="login2.php" method="POST" class="form login">
                ...
                <div class="form__field">
                    ...
                    <input autocomplete="email" id="login__email" type="email" name="email" class="form__input"
                ...
                <p class="text--center"> <a href="signup.php">Dont have an account? Create one</a> <svg class="icon">
