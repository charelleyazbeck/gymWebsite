                    ...
                    <div class="nav-menu">
                        <nav class="mainmenu mobile-menu">
                            <ul>
                                ...
                                <li class="active"><a href="./scheduleClientSide.php">Schedule</a></li>
                    ...
                    <table>
                        ...
                        <tbody>
                                ...
                                function formatTime($startTime, $duration) {
                                    ...
                                    return "$startTime:00 - $endTime";// explained in the privateschedule
                                }

                                $c = 10; // Initial time set to 10:00 for all classes
                                for ($i = 1; $i <= 6; $i++) {
                                    echo "<tr>";
                                    ...
                                    for ($j = 1; $j <= 7; $j++) {
                                        ...
                                        if ($result && $result->num_rows > 0) {
                                            ...
                                            if ($row['pbCStatus'] == 'exists') {
                                                ...
                                                // Display "No Session" if pbCStatus is not "exists" yaane nosession
                                                echo "<td>";
                                                echo '';
                                                echo "</td>";
                                            }
                                        } else {
                                            // Display nothing if no session data exists
                                            echo "<td>";
                                            echo '';
                                            echo "</td>";
                                        }
...
<section class="chooseus-section spad" style="background-color:black">  
        ...
        <script>
                                    ...
                                    function filterClasses(category) {
                                        const allItems = document.querySelectorAll('.ts-item');

                                        allItems.forEach(function (item) {
                                            if (category === 'all' || item.getAttribute('data-tsmeta') === category) {
                                        ...
                                        // Update active state on the filter buttons or tabs
                                        const allFilters = document.querySelectorAll('.timetable-controls li');
                                        allFilters.forEach(function (filter) {
                                            if (filter.getAttribute('data-tsfilter') === category || category === 'all') {
