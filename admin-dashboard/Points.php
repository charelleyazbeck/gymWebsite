...
<script src="js/main.js"></script>
    ...
    <form action="PointsUserAdd.php" method="post" class="form1">
    <table>
        <tr><td colspan="2"><h2>Add points to a user :</h2></td></tr>
        <tr><td><input type="text" placeholder="User Id" name="PointsUserId"></td></tr>
        <tr><td><input type="text" placeholder="Amount of points" name="PointsAmount"></td><td><input type="submit" value="Send"></td></tr>
