...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="col-lg-12">
                        <div class="breadcrumb-text">
                            ...
                            <div class="breadcrumb-controls">
                                <a href="index.php#classSection"><i class="fa fa-home"></i> Home</a>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-text">
                            ...
                            <p>Resistance training (also called strength training or weight training) is the use of resistance to muscular contraction to build strength, anaerobic endurance and size of skeletal muscles.</p>
                            <p>Resistance training is based on the principle that muscles of the body will work to overcome a resistance force when they are required to do so. When you do resistance training repeatedly and consistently, your muscles become stronger.</p>
                            <p>A well-rounded fitness program includes strength training to improve joint function, bone density, muscle, tendon and ligament strength, as well as aerobic exercise to improve your heart and lung fitness, flexibility and balance exercises.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Hero Section Begin -->
        <section class="hero-section set-bg spad" style="background-color: black;" >
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hero-text">
                            <h2>Resistance Registration</h2>
                            <p>Get fit, feel strong, and unleash your potential with our Resistance program.</p>
                            <a href="scheduleClientSide.php?filter=resistance#timetable" class="primary-btn">Register Now</a>
                        </div>
                    </div>
                </div>
            </div>
