...
<div>
    <form>
            <table border="2" style="margin: 3px;" class="viewtable">
                <thead>
                <?php
                $query = "SELECT * FROM orders WHERE oStatus = 'pending'";
                $res = $con->query($query);
                if ($res) {
                    echo "<tr><th>Order ID</th><th>Total Price</th><th>Show Product</th><th>Assign Order</th><th>Client ID</th></tr></thead><tbody>";
                ...
                <td><a href='assignorder.php?order_id=$row[o_ID]'><img src='assignicon.png' width='45px' height='40px'></a></td>";
                            echo "<td>$row[c_ID]</td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
